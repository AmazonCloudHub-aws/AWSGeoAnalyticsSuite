...
def process_seismic_data(seismic_file):
    ...
    # Return processed seismic data and metadata
...
def upload_to_s3(processed_data, bucket_name, object_key):
    ...
    # Write processed data to MiniSEED file
    processed_data["data"].write("temp.mseed", format="mseed", byteorder='<')

    # Upload MiniSEED file to S3 bucket
...
object_key = "processed_data.mseed"
